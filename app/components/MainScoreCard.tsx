...
export default function MainScoreCard() {
  return (
    <div className="grid grid-cols-1 gap-6 rounded-3xl border border-[#d9e6f7] bg-linear-to-b from-[#f8fbff] to-[#f2f7fd] p-4 shadow-lg sm:p-6 lg:grid-cols-[1.1fr_1.4fr] lg:gap-7">
      <div className="relative">
        <div className="relative rounded-2xl bg-[#f7f1f4] px-3 pb-4 pt-5 shadow-md sm:px-5 sm:pb-5 sm:pt-6">
          <div className="relative mx-auto mt-8 h-32 w-full max-w-[17.5rem] rounded-t-full border-12 border-b-0 border-[#f0f0f0] sm:h-40 sm:max-w-[20rem]">
            <div
              className="absolute -left-6 -top-6 h-32 w-full max-w-[17.5rem] rounded-t-full border-2 border-b-0 border-transparent sm:-left-8 sm:-top-8 sm:h-40 sm:max-w-[20rem]"
              style={{
            ...
            />
            <div
              className="absolute right-2 top-2 h-6 w-8 rotate-12 sm:h-7 sm:w-9"
              style={{
                background: "#FFBC70",
          ...
          <div className="pointer-events-none absolute left-1/2 top-1/2 h-4 w-56 -translate-x-1/2 translate-y-2 bg-[#f7f1f4] sm:w-72" />

          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 translate-y-2 text-center">
            <div
              className="text-4xl font-bold text-[#FF6969] drop-shadow-sm sm:text-6xl"
            >
              43
            </div>
            <div className="mt-1 text-xs font-semibold text-[#2f4d76] sm:text-[15px]">
              Current WealthUp Score
            </div>
          </div>

          <div className="mt-16 text-center text-xs font-medium italic text-[#2f4d76] sm:mt-24 sm:text-[14px]">
            Better than <strong>46%</strong> of peers
          </div>

          <div className="absolute left-1/2 top-3 w-[12.5rem] -translate-x-1/2 rounded-lg bg-white px-3 py-2 text-[11px] text-[#3a3a3a] shadow-md sm:top-4 sm:w-48 sm:text-[13px]">
      ...
      <div>
        ...
        <div className="relative mb-5 grid grid-cols-1 overflow-hidden rounded-xl border border-[#d6e6f7] bg-white shadow-md sm:grid-cols-2">
          ...
          <div className="border-t border-[#dde8f6] bg-[#eaf4ff] px-4 py-4 text-center sm:border-l sm:border-t-0 sm:px-6">
          ...
          <div className="absolute left-1/2 top-1/2 z-10 -translate-x-1/2 -translate-y-1/2 sm:top-[46%]">
            <div
              className="rounded-full bg-[#18b014] px-3 py-1 pr-4 text-[11px] font-semibold text-white shadow-md sm:text-xs"
              style={{
                clipPath:
